...
# KAGAT-NA1-AT Layer (Sparse Graph)
class KANGraphAttentionLayerARC4(nn.Module):
    def __init__(self, in_features, out_features, dropout):
        super(KANGraphAttentionLayerARC4, self).__init__()
...
# KAGAT-NA1-AT 2-Layer Model (Sparse Graph)
class KAGATa4(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nheads):
        super(KAGATa4, self).__init__()
        self.dropout = dropout
        self.attentions = nn.ModuleList(
            [KANGraphAttentionLayerARC4(nfeat, nhid, dropout=dropout) for _ in range(nheads)]
        )
        self.out_att = KANGraphAttentionLayerARC4(nhid * nheads, nclass, dropout=dropout)
...
class KAGATa4(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout, nheads):
        super(KAGATa4, self).__init__()
        self.dropout = dropout
        self.attentions = [KANGraphAttentionLayerARC4(nfeat, nhid, dropout=dropout) for _ in range(nheads)]
